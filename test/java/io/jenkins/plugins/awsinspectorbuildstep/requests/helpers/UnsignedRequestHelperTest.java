...
import static io.jenkins.plugins.awsinspectorbuildstep.requests.helpers.UnsignedRequestHelper.getXAmzDateString;
...
public class UnsignedRequestHelperTest {
    ...
    public void testBuildRequest_Success() throws IOException, URISyntaxException {
        ...
        SdkHttpFullRequest request = new UnsignedRequestHelper(new PrintStream(System.out),
                "test", filePath).getRequest();
